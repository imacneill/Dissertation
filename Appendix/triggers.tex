...
\begin{table}[h]
\begin{center}
\caption{\small \label{tab:ElFRTriggers} Triggers used while measuring the electron Fake Rate}
...
\begin{table}[h]
\begin{center}
\caption{\small \label{tab:MuFRTriggers} Triggers used while measuring the muon Fake Rate}
\begin{tabular}{l} \hline \hline
        Triggers       \\ \hline
\verb=HLT_Mu8_v=   \\
\verb=HLT_Mu17_v=   \\  
